default: test.good.elf test.bad.elf test.nolst.elf

################################################################################
# Known bad case. These are the parameters generated by my usual build scripts
################################################################################
main.bad.o:
...
################################################################################
# Removing listing generation
# It seems the generation of the listing when compiling the C file triggers
# the issue
################################################################################
main.nolst.o:
...
test.nolst.elf: main.nolst.o startup.nolst.o
